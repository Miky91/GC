...
public:
	...
	void add(CTex2 v){ s = s + v.s; t = t + v.t;};
public:
	GLdouble s, t;
};
...
{
public:
	Color4(GLdouble x, GLdouble y, GLdouble z, GLdouble w) : r(x), g(y), b(z), a(w){};
	~Color4() {};
	void set(GLdouble px, GLdouble py, GLdouble pz, GLdouble pw){ r = px; g = py; b = pz; a = pw; };
